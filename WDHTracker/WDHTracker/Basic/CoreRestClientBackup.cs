...
namespace WDHTracker.Basic
{
    ...
    /// </summary>
    public abstract class CoreRestClientBackup
    {
        ...
        public CoreRestClientBackup(HttpClient httpClient, IOAuth2ClientAuthentication auth)
        {
        ...
        public virtual HttpResponseMessage SendRequest(HttpMethod httpMethod, string relativeUrl, bool withToken = true, HttpContent content = null)
        {
            ...
            {
                MessagingCenter.Send<CoreRestClientBackup>(this, "wrongPassword");
